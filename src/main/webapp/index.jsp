...
<div class="dashboard">
    <div class="left">
        <div class="sidebar">
            <div class="wrapper">
                <div class="menu">
                    <img src="https://i.ibb.co/B4Dn7CT/menu.png" alt=""/>
                </div>
                <div class="items">
                    <img src="https://i.ibb.co/L8D5T60/light.png" alt=""/>
                    <img src="https://i.ibb.co/zmDbMVZ/diamond.png" alt=""/>
                    <img src="https://i.ibb.co/W5QZ9Fk/envelope.png" alt=""/>
                    <img src="https://i.ibb.co/CnKDBxC/flask.png" alt=""/>
                    <img src="https://i.ibb.co/MGs4Fyn/sent-mail.png" alt=""/>
                    <img src="https://i.ibb.co/zGtDpcp/map.png" alt=""/>
                </div>
                <div class="profile">
        ...
        <div class="navigation">
            <div class="wrapper2">
                <div class="abilan">
                    <img src="https://i.ibb.co/HgJrt1p/abilan.png" alt=""/>
                </div>
                <button class="compose">Compose Mail
                    <span class="plus">
            <img src="https://i.ibb.co/v1HxGWj/add-1.png" alt=""/></span></button>
                <div class="folders">Folders</div>
                <div class="folder-icons">
                    <div class="icon1">
                        <img src="https://i.ibb.co/qdgf3TJ/envelope.png" alt=""/>
                    </div>
                ...
                <div class="folder-icons">
                    <div class="icon1">
                        <img src="https://i.ibb.co/3MzfGDF/bug.png" alt=""/>
                    </div>
                    <div class="icon-name">Spam</div>
                </div>
                <div class="folder-icons">
                    <div class="icon1">
                        <img src="https://i.ibb.co/xfcFLCN/waste-bin.png" alt=""/>
                    </div>
                    <div class="icon-name">Trash</div>
                </div>
                <div class="folder-icons">
                    <div class="icon1">
                        <img src="https://i.ibb.co/xfcFLCN/customer.png" alt=""/>
                    </div>
                    <a href="http://localhost:8080/mvc-jpa-mysql-v2/customer/list" class="icon-name">Customers</a>
                </div>
                <div class="folders">
                    Online Friends
                </div>
